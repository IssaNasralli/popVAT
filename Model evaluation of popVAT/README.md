...
```bash
python r_squared.py --raster tunisia10_popVAE_full_GAG_1025_20__best_weights_popVAE_full_Tunisia_GAG_1025_20_21.h5__21_predicted.tif --csv ins_population.csv --region Tunisia --nb_masks 24
```
...
--region      Country or region name (Tunisia)
--nb_masks    Number of administrative region masks (24)
```
Our population raster datasets for **Tunisia** generated by our popVAT model  are available here:  👉 [Download](https://drive.google.com/file/d/1qEwJSUJAM2eUU59YV1DE60eMvNH9EtJd/view?usp=sharing)
