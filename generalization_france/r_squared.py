...
def main(args):
    ...
    ev.calculate_district_mae(target_data, district_masks, ins_population)
    ev.calculate_district_mse(target_data, district_masks, ins_population)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--nb_masks', type=int, required=True, default="24", help="Number of district masks to load")
